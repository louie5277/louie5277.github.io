					...
					$('.gallery')
						...
						.scrollex({
							...
							enter:      function() {
								...
								$('.image-container').css({
									transform: 'translateX(0)', /* Move image into view from the left */
									opacity: 1
								});
							},
							leave:      function() {
								$(this).addClass('inactive');
								// Optionally, reset the image position when leaving
								$('.image-container').css({
									transform: 'translateX(-100%)', /* Move image off-screen again */
									opacity: 0
								});
							}
						});
